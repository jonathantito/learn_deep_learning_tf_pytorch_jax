...
# #example of setup.py used by KerasCV team
# needs:
# README.md
# version_utils.py
# MANIFEST.in
...
setup(
    name="keras-cv modificado",
    description="Usado como base para aprender deep learning en un PC con vscode sobre un devcontainer",
    long_description=README,
    long_description_content_type="text/markdown",
    version=VERSION,
    url="https://github.com/keras-team/keras-cv",
    author="Keras team, Jonathan Eduardo Tito Ontaneda",
    author_email="keras-cv@google.com,titoontaneda.eco.ai.tech@gmail.com",
